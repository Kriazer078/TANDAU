  ...
  static Future<void> preloadFonts() async {
    try {
      await GoogleFonts.pendingFonts([
        GoogleFonts.inter(fontWeight: FontWeight.w400), // body text
        GoogleFonts.inter(fontWeight: FontWeight.w500), // nav labels, hints
        GoogleFonts.inter(fontWeight: FontWeight.w600), // section headers
        GoogleFonts.inter(fontWeight: FontWeight.bold), // titles (w700)
      ]);
    } catch (_) {
